    ...
    >
      ...
      >
        <AnimationRevealPage disabled>
          ...
          <OutNav>
            <Container>
              <ContainerHeading tw="pl-8 pt-8 text-3xl">Advertising</ContainerHeading>
              <Page tw="block pl-6 mt-4 px-5">
                <div class="underconstruction" tw="w-full pl-2">
                  <p>For advertising kindly send us with your company and ad details on <a href="mailto:advertisment@mobiwood.net" tw="font-bold">advertisment@mobiwood.net</a>.</p>
